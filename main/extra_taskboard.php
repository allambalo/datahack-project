...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/extra_taskboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Dec 2020 10:26:35 GMT -->
<head>
  <meta charset="utf-8">
		  ...
		  <div class="row">
			...
			<div class="col-xl-4 connectedSortable">
			  <div class="box box-solid box-primary">
				<div class="box-header with-border">
				  <h4 class="box-title">Предстоящие события</h4>
			...
			<div class="col-xl-4 connectedSortable">
			  <div class="box box-solid box-success">
				<div class="box-header with-border">
				  <h4 class="box-title">Завершенные</h4>
				  <ul class="box-controls pull-right">
					<li><a class="box-btn-close" href="#"></a></li>
					<li><a class="box-btn-slide" href="#"></a></li>	
					<li><a class="box-btn-fullscreen" href="#"></a></li>
...
<!-- ./wrapper -->
    ...
    <script src="../assets/icons/feather-icons/feather.min.js"></script>	<script src="../assets/vendor_components/jquery-ui/jquery-ui.js"></script>
	<script>
