...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/widgets_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Dec 2020 10:27:56 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>EduAdmin - Dashboard  List Widgets</title>
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div class="d-flex align-items-center">
							...
							<div class="d-flex flex-column font-weight-500">
								<a href="#" class="text-dark hover-warning mb-1 font-size-16">Testing</a>
			  ...
			  <div class="col-12 col-xl-4">
				<div class="box bg-primary-light">
					<div class="box-header with-border">
						...
						<ul class="box-controls pull-right">
						  <li class="dropdown">
							<a data-toggle="dropdown" href="#" class="px-10 pt-5"><i class="ti-more-alt text-primary"></i></a>
							<div class="dropdown-menu dropdown-menu-right">
							  <a class="dropdown-item" href="#"><i class="ti-import"></i> Import</a>
							  <a class="dropdown-item" href="#"><i class="ti-export"></i> Export</a>
							  <a class="dropdown-item" href="#"><i class="ti-printer"></i> Print</a>
					...
					<div class="box-body">
						<div class="d-flex align-items-center mb-30">
							...
							<div class="d-flex flex-column font-weight-500">
								<a href="#" class="text-dark hover-primary mb-1 font-size-16">Sophia</a>
						...
						<div class="d-flex align-items-center mb-30">
							...
							<div class="d-flex flex-column font-weight-500">
								<a href="#" class="text-dark hover-danger mb-1 font-size-16">Mason</a>
						...
						<div class="d-flex align-items-center mb-30">
							...
							<div class="d-flex flex-column font-weight-500">
								<a href="#" class="text-dark hover-success mb-1 font-size-16">Emily</a>
						...
						<div class="d-flex align-items-center mb-30">
							...
							<div class="d-flex flex-column font-weight-500">
								<a href="#" class="text-dark hover-info mb-1 font-size-16">Daniel</a>
						...
						<div class="d-flex align-items-center mb-25">
							...
							<div class="d-flex flex-column font-weight-500">
								<a href="#" class="text-dark hover-warning mb-1 font-size-16">Natalie</a>
				...
				<div class="box">
					<div class="box-header with-border">
						...
						<ul class="box-controls pull-right d-md-flex d-none">
						  <li class="dropdown">
							<button class="btn btn-primary dropdown-toggle px-10 " data-toggle="dropdown" href="#">Create</button>
							<div class="dropdown-menu dropdown-menu-right">
							  <a class="dropdown-item" href="#"><i class="ti-import"></i> Import</a>
							  <a class="dropdown-item" href="#"><i class="ti-export"></i> Export</a>
							  <a class="dropdown-item" href="#"><i class="ti-printer"></i> Print</a>
				...
				<div class="box">
					...
					<div class="box-body">
						...
						<div class="d-flex align-items-center mb-25">
							...
							<div class="d-flex flex-column flex-grow-1">
								<a href="#" class="text-dark hover-primary font-weight-500 font-size-16">
						...
						<div class="d-flex align-items-center mb-25">
							...
							<div class="d-flex flex-column flex-grow-1">
								<a href="#" class="text-dark hover-danger font-weight-500 font-size-16">
						...
						<div class="d-flex align-items-center mb-25">
							...
							<div class="d-flex flex-column flex-grow-1">
								<a href="#" class="text-dark hover-info font-weight-500 font-size-16">
						...
						<div class="d-flex align-items-center mb-25">
							...
							<div class="d-flex flex-column flex-grow-1">
								<a href="#" class="text-dark hover-warning font-weight-500 font-size-16">
									Aliquam in magna
								</a>
								<span class="text-fade font-weight-500">
									Due in 2 Days
			  ...
			  <div class="col-12 col-xl-4">
				<div class="box bg-success-light">
					<div class="box-header with-border">
						...
						<ul class="box-controls pull-right d-md-flex d-none">
						  <li class="dropdown">
							<button class="btn btn-success dropdown-toggle px-10 " data-toggle="dropdown" href="#">Create</button>
							<div class="dropdown-menu dropdown-menu-right">
							  <a class="dropdown-item" href="#"><i class="ti-import"></i> Import</a>
							  <a class="dropdown-item" href="#"><i class="ti-export"></i> Export</a>
							  <a class="dropdown-item" href="#"><i class="ti-printer"></i> Print</a>
					...
					<div class="box-body">
						<div class="d-flex align-items-center mb-25">						
							...
							<div class="d-flex flex-column flex-grow-1">
								...
								<span class="text-mute font-weight-500">
									Due in 2 Days
								</span>
							</div>
							<div class="dropdown">
			  ...
			  <div class="col-12 col-xl-4">
				<div class="box">
					...
					<div class="box-body">
						...
						<div class="d-flex align-items-center mb-30">
							<div class="mr-15 bg-lightest h-50 w-50 l-h-50 rounded text-center">
								  <img src="https://www.multipurposethemes.com/admin/eduadmin-template/images/svg-icon/color-svg/004-dad.svg" class="h-30" alt="">
							</div>
							<div class="d-flex flex-column flex-grow-1 mr-2 font-weight-500">
								<a href="#" class="text-dark hover-info mb-1 font-size-16">Phasellus venenatis nisi</a>
								<span class="text-fade">Pharetra, Nulla , Nec, Aliquet</span>
							</div>
							<span class="badge badge-xl badge-light"><span class="font-weight-600">+125$</span></span>
						</div>
						<div class="d-flex align-items-center">
							...
							<div class="d-flex flex-column flex-grow-1 mr-2 font-weight-500">
								<a href="#" class="text-dark hover-warning mb-1 font-size-16">Vivamus consectetur</a>
								<span class="text-fade">Pharetra, Nulla , Nec, Aliquet</span>
							</div>
							<span class="badge badge-xl badge-light"><span class="font-weight-600">+125$</span></span>
						</div>
				...
				<div class="box">
					<div class="box-header with-border">
						...
						<div class="dropdown pull-right">
							<h6 class="dropdown-toggle mb-0" data-toggle="dropdown">Today</h6>
					...
					<div class="box-body">
					  <div class="media-list media-list-divided">
						<div class="media media-single px-0">
						  <div class="ml-0 mr-15 bg-success-light h-50 w-50 l-h-50 rounded text-center">
						  	<span class="font-size-24 text-success"><i class="fa fa-file-pdf-o"></i></span>
						  </div>
						  <span class="title font-weight-500 font-size-16">Deeveloper Manual</span>
						...
						<div class="media media-single px-0">
						  ...
						  <span class="title font-weight-500 font-size-16">Documentation</span>
						  <a class="font-size-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>

						<div class="media media-single px-0">
						  <div class="ml-0 mr-15 bg-warning-light h-50 w-50 l-h-50 rounded text-center">
						    <span class="font-size-24 text-warning"><i class="fa fa-file-excel-o"></i></span>
						  </div>
						  <span class="title font-weight-500 font-size-16">Download Excel version</span>
						  <a class="font-size-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>

						<div class="media media-single px-0">
						  <div class="ml-0 mr-15 bg-danger-light h-50 w-50 l-h-50 rounded text-center">
						    <span class="font-size-24 text-danger"><i class="fa fa-file-zip-o"></i></span>
						  </div>
						  <span class="title font-weight-500 font-size-16">Download Ziped version</span>
						  <a class="font-size-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>

						<div class="media media-single px-0">
						  <div class="ml-0 mr-15 bg-info-light h-50 w-50 l-h-50 rounded text-center">
						    <span class="font-size-24 text-info"><i class="fa fa-file-word-o"></i></span>
						  </div>
						  <span class="title font-weight-500 font-size-16">Download Word version</span>
						  <a class="font-size-18 text-gray hover-info" href="#"><i class="fa fa-download"></i></a>
						</div>
					  </div>
				  </div>
					  ...
					  <div class="media-list media-list-hover">
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body font-weight-500">
							<p class="font-size-16">Pellentesque rhoncus ipsum vel mauris sagittis, vulputate semper arcu consectetur.</p>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body font-weight-500">
							<p class="font-size-16">Pellentesque blandit odio id felis semper, imperdiet sagittis purus tincidunt.</p>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body font-weight-500">
							<p class="font-size-16">Aenean tincidunt tortor sit amet erat rutrum, vel condimentum ipsum gravida.</p>
						...
						<a class="media media-single" href="#">
						  ...
						  <div class="media-body font-weight-500">
							<p class="font-size-16">Vivamus condimentum erat non turpis placerat, at volutpat metus commodo.</p>
							<span class="text-fade">55 min ago</span>
						  </div>
						</a>
						...
						<div class="media">
						  ...
						  <div class="media-body font-weight-500">
							<p>
							  ...
							  <span class="float-right text-fade">23 hours ago</span>
							</p>
						  ...
						  <div class="media-body font-weight-500">
							...
							<div class="media-block-actions">
							  ...
							  <nav class="nav no-gutters gap-2 font-size-16 media-hover-show">
								<a class="nav-link text-success" href="#" data-toggle="tooltip" title="Approve"><i class="ion-checkmark"></i></a>
								<a class="nav-link text-danger" href="#" data-toggle="tooltip" title="Delete"><i class="ion-close"></i></a>
							  </nav>
							</div>
						  </div>
						</div>
			  ...
			  <div class="col-xl-4 col-12">
				<div class="box">
				  ...
				  <div class="text-center bt-1 border-light p-10">
					<a class="text-uppercase d-block font-size-12" href="#">See all recent posts</a>
				  </div>
				</div>
			  </div>
					...
					<div class="box-body p-0">
					  <div class="media-list media-list-hover media-list-divided inner-user-div" style="height: 345px">
						<div class="media media-single">
						  ...
						  <div class="media-right">
							<a class="btn btn-block btn-info btn-sm" href="#">Followed</a>
						  </div>
						</div>
						...
						<div class="media media-single">
						  ...
						  <div class="media-right">
							<a class="btn btn-block btn-success btn-sm" href="#">Follow</a>
						  </div>
						</div>
					...
					<div class="box-body p-0">
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-11.png" alt="..."> <span class="ml-15 font-size-18">Olivia</span>
							  </div>
					  ...
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-12.png" alt="..."> <span class="ml-15 font-size-18">William</span>
							  </div>
							  <div class="align-self-center">
					  ...
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-10.png" alt="..."> <span class="ml-15 font-size-18">Emily</span>
							  </div>
							  <div class="align-self-center">
					  ...
					  <div class="media">
						<div class="media-body">
							<div class="flexbox">
							  <div class="clearfix">
								<img class="avatar avatar-lg rounded bg-success-light" src="../images/avatar/avatar-13.png" alt="..."> <span class="ml-15 font-size-18">Madison</span>
							  </div>
							  <div class="align-self-center">
...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/widgets_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Dec 2020 10:28:01 GMT -->
</html>
