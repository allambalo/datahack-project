...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/forms_validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Dec 2020 10:27:20 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>EduAdmin - Dashboard  Form Validation </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Добавить курс</h3>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Форма для добавления курса</h4>
					  ...
					  <div class="row">
						<div class="col-12">						
							<div class="form-group">
								<h5>Название курса <span class="text-danger">*</span></h5>
								<div class="controls">
