...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/contact_app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Dec 2020 10:26:41 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>EduAdmin - Dashboard  Contact / Employee </title>
	  ...
	  <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Контактные номара учителей</h3>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Полезное</li>
					...
					<div class="box-body p-0">
					  <div class="flexbox align-items-center p-15">
						<div class="flexbox align-items-center">
						  ...
						  <div class="dropdown">
							<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">Перейти</button>
						  ...
						  <div class="dropdown d-none d-sm-block">
							<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">Сортировать</button>
							<div class="dropdown-menu">
...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/contact_app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Dec 2020 10:26:42 GMT -->
</html>
